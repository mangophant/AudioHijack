...
from .audio_utils import load_audio_as
...
from transformers.utils import PaddingStrategy, TensorType, add_end_docstrings, logging, to_py_obj, import_utils
...
if "mistral-common" not in import_utils.BACKENDS_MAPPING:
    ...
    import_utils.BACKENDS_MAPPING["mistral-common"] = is_mistral_common_available
    print("[INFO] Patched BACKENDS_MAPPING with 'mistral-common'")
else:
    print("[INFO] 'mistral-common' already registered")
