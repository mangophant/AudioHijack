...
class QuantizedBaseModelOutput(BaseModelOutput):
    ...
    # TODO: [modified] return distances for soft quantization
    distances: Optional[torch.LongTensor] = None
...
def vector_quantize(inputs, codebook):
    ...
    # TODO: [modified] return distances for soft quantization
    distances = distances.view(inputs.shape[0], inputs.shape[1], -1)
...
class WhisperVQEncoder(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        return QuantizedBaseModelOutput(
            ...
            quantized_token_ids=quantized_token_ids, distances=distances
        )
